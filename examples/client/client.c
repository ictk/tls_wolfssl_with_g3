...
//-h a1osxd2p57u8ac.iot.us-west-2.amazonaws.com -p 8883 -c ./certs/aws/device.crt -k ./certs/aws/device.key -A ./certs/aws/ca.crt -l ECDHE-ECDSA-AES128-SHA256
//-h 192.168.0.77  -p 8883 -c ./certs/aws/device.crt -k ./certs/aws/device.key -A ./certs/aws/ca.crt -l ECDHE-ECDSA-AES128-SHA256
//-h 192.168.0.77  -p 1350 -A ./certs/ecc/ca.crt -l ECDHE-ECDSA-AES128-SHA256
//-h 192.168.0.77  -p 8883 -A ./certs/ecc/ca.crt  -c ./certs/ecc/client.crt -k ./certs/ecc/client.key -l ECDHE-ECDSA-AES128-SHA256
/*
...
THREAD_RETURN WOLFSSL_THREAD client_test(void* args)
{
 ...
 || defined(HAVE_CERTIFICATE_STATUS_REQUEST_V2)
    ...
    while ((ch = mygetopt(argc, argv, "?"
            "ab:c:defgh:ijk:l:mnop:q:rstv:wxyz"
			"u:A:B:CDE:F:GH:IJKL:M:NO:PQRS:TUVW:XYZ:"
            "03:2")) != -1) {
        switch (ch) {
            case '?' :
                Usage();
