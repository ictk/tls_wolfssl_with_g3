...
NEO_API int neo_ssl_server_certificate(const byte * hash_cert,const byte * sign_asn1,const byte* pubkey_asn1);
NEO_API int neo_ssl_server_key_exchange(const byte* pubkey_asn1_4_ecdh);
NEO_API int neo_ssl_client_certificate(const byte * hash_cert,byte * sign_asn1,int * psign_size);
NEO_API int neo_ssl_client_key_exchange(const byte * pubkey,byte* chip_pub_asn1_4_ecdh);
NEO_API int neo_ssl_client_certificate_verify(const byte * hash);
