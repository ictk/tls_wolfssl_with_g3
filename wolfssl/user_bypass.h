...
typedef int( * PF_NEO_SSL_SERVER_CERTIFICATE)(const byte * hash_cert,const byte * sign_asn1,const byte* pubkey_asn1);
typedef int( * PF_NEO_SSL_SERVER_KEY_EXCHANGE)(const byte* pubkey_asn1_4_ecdh);
typedef int( * PF_NEO_SSL_CLIENT_CERTIFICATE)(const byte * hash_cert,byte * sign_asn1,int * psign_size);
typedef int( * PF_NEO_SSL_CLIENT_KEY_EXCHANGE)(const byte * pubkey,byte* chip_pub_asn1_4_ecdh);
typedef int( * PF_NEO_SSL_CLIENT_CERTIFICATE_VERIFY)(const byte * hash);
typedef int( * PF_NEO_SSL_CLIENT_ENCRYPTED_HANDSHAKE_MESSAGE)(const byte * hash,byte* out,int* pout_size);
typedef int( * PF_NEO_SSL_SERVER_ENCRYPTED_HANDSHAKE_MESSAGE)(const byte * hash);
...
typedef struct _tagST_WC_ECC_FUNCTIONS{
	...
	PF_NEO_SSL_SERVER_CERTIFICATE pf_neo_ssl_server_certificate;
	PF_NEO_SSL_SERVER_KEY_EXCHANGE pf_neo_ssl_server_key_exchange;
	PF_NEO_SSL_CLIENT_CERTIFICATE pf_neo_ssl_client_certificate;
	PF_NEO_SSL_CLIENT_KEY_EXCHANGE pf_neo_ssl_client_key_exchange;
	PF_NEO_SSL_CLIENT_CERTIFICATE_VERIFY pf_neo_ssl_client_certificate_verify;
	PF_NEO_SSL_CLIENT_ENCRYPTED_HANDSHAKE_MESSAGE pf_neo_ssl_client_encrypted_handshake_message;
	PF_NEO_SSL_SERVER_ENCRYPTED_HANDSHAKE_MESSAGE pf_neo_ssl_server_encrypted_handshake_message;
