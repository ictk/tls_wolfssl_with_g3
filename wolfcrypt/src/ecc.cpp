...
#define TAG_ECC_TITLE_FMT "@@@@@@@NEO_ECC_API:%s===================================>\n"
...
void set_user_wc_ecc_functions(LPST_WC_ECC_FUNCTIONS lpst_wc_ecc_functions)
{
	_cur_pwc_ecc_functions = lpst_wc_ecc_functions;
}

LPST_WC_ECC_FUNCTIONS get_user_wc_ecc_functions()
{
	return _cur_pwc_ecc_functions;
}
...
int ecc_map()
{
	PRT_TITLE prttitle("ecc_map");
	int ret = _cur_pwc_ecc_functions->pf_ecc_map();
	return ret;
}
