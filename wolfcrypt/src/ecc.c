...
{
	//print_title("ecc_projective_add_point");
...
{
	//print_title("ecc_projective_dbl_point");
...
{
	//print_title("wc_ecc_new_point_h");
...
{
	//print_title("wc_ecc_del_point_h");
...
{
	//print_title("wc_ecc_is_valid_idx");
	   int x;
...
{
	print_title("wc_ecc_get_curve_idx");
	    int curve_idx;
...
{
	print_title("wc_ecc_get_curve_id");
...
{
	//print_title("wc_ecc_get_curve_size_from_id");
	    int curve_idx = wc_ecc_get_curve_idx(curve_id);
    if (curve_idx == ECC_CURVE_INVALID)
        return ECC_BAD_ARG_E;
...
{
	//print_title("wc_ecc_get_curve_idx_from_name");
	    int curve_idx;
    word32 len;
...
{
	print_title("wc_ecc_get_curve_size_from_name");
	    int curve_idx;
...
{
	print_title("wc_ecc_get_curve_id_from_name");
	    int curve_idx;
...
{
	print_title("wc_ecc_get_curve_id_from_params");
	    int idx;
    int curveSz;
...
{
	print_title("wc_ecc_shared_secret_gen");
	    int err;
...
int wc_ecc_shared_secret_ex(ecc_key* private_key, ecc_point* point,
                            byte* out, word32 *outlen)
{
	print_title("wc_ecc_shared_secret_ex");
	    int err;
...
{
	print_title("wc_ecc_point_is_at_infinity");
	    if (p == NULL)
        return BAD_FUNC_ARG;
...
{
	print_title("wc_ecc_make_key_ex");
	    int            err;
#ifndef WOLFSSL_ATECC508A
    DECLARE_CURVE_SPECS(ECC_CURVE_FIELD_COUNT)
#endif
...
{
	print_title("wc_ecc_init");
	    return wc_ecc_init_ex(key, NULL, INVALID_DEVID);
}

int wc_ecc_set_flags(ecc_key* key, word32 flags)
{
	print_title("wc_ecc_set_flags");
	    if (key == NULL) {
        return BAD_FUNC_ARG;
    }
    key->flags |= flags;
...
{
	print_title("wc_ecc_sign_hash_ex");
	   int    err;
   mp_int e;
...
int wc_ecc_verify_hash_ex(mp_int *r, mp_int *s, const byte* hash,
                    word32 hashlen, int* res, ecc_key* key)
{
	print_title("wc_ecc_verify_hash_ex");
	   int           err;
#ifndef WOLFSSL_ATECC508A
   int          did_init = 0;
...
int wc_ecc_import_point_der(byte* in, word32 inLen, const int curve_idx,
                            ecc_point* point)
{
	print_title("wc_ecc_import_point_der");
	    int err = 0;
    int compressed = 0;
...
int wc_ecc_export_point_der(const int curve_idx, ecc_point* point, byte* out,
                            word32* outLen)
{
	print_title("wc_ecc_export_point_der");
	    int    ret = MP_OKAY;
    word32 numlen;
#ifndef WOLFSSL_ATECC508A
#ifdef WOLFSSL_SMALL_STACK
...
{
	print_title("wc_ecc_export_private_only");
	    word32 numlen;
		int ret;
   ...
   return BAD_COND_E;
	...
	print_hexdumpbin("wc_ecc_export_private_only out", out, *outLen);
	return ret;
#endif /* WOLFSSL_ATECC508A */
}
...
{
	print_title("wc_ecc_export_public_raw");
...
int wc_ecc_export_private_raw(ecc_key* key, byte* qx, word32* qxLen,
                              byte* qy, word32* qyLen, byte* d, word32* dLen)
{
	print_title("wc_ecc_export_private_raw");
...
{
	print_title("wc_ecc_import_raw_ex");
           ...
           case ecAES_128_CBC:
               {
                   ...
                   if (ret != 0)
                       break;
                   ret = wc_AesCbcEncrypt_org(&aes, out, msg, msgSz);
                #if defined(WOLFSSL_ASYNC_CRYPT)
           ...
           case ecAES_128_CBC:
               {
                   ...
                   if (ret != 0)
                       break;
                   ret = wc_AesCbcDecrypt_org(&aes, out, msg, msgSz-digestSz);
                #if defined(WOLFSSL_ASYNC_CRYPT)
                   ret = wc_AsyncWait(ret, &aes.asyncDev, WC_ASYNC_FLAG_NONE);
                #endif
               }
