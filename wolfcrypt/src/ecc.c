...
int wc_ecc_shared_secret(ecc_key* private_key, ecc_key* public_key, byte* out,
                      word32* outlen)
{
	print_title("wc_ecc_shared_secret");
	   int err;
...
#endif /* WOLFSSL_ATECC508A */
   print_hexdumpbin("wc_ecc_shared_secret OUT", out,*outlen);
   return err;
}
                     ...
                     WC_RNG* rng, ecc_key* key)
{
    ...
    switch(key->state) {
        ...
        case ECC_STATE_SIGN_ENCODE:
			...
			print_hexdumpbin("r", r->dp, r->alloc*4);
			print_hexdumpbin("s", s->dp, s->alloc * 4);
            /* always free r/s */
            mp_clear(r);
            mp_clear(s);
            break;
...
{
	print_title("wc_ecc_verify_hash");
...
{
	print_title("wc_ecc_export_x963");
	   int    ret = MP_OKAY;
   word32 numlen;
#ifndef WOLFSSL_ATECC508A
#ifdef WOLFSSL_SMALL_STACK
...
#endif
#endif /* WOLFSSL_ATECC508A */
   print_hexdumpbin("wc_ecc_export_x963 out", out, *outLen);
...
int wc_ecc_export_x963_ex(ecc_key* key, byte* out, word32* outLen,
                          int compressed)
{
	print_title("wc_ecc_export_x963_ex");
	    if (compressed == 0)
...
int wc_ecc_import_x963_ex(const byte* in, word32 inLen, ecc_key* key,
                          int curve_id)
{
	print_title("wc_ecc_import_x963_ex");
	print_hexdumpbin("wc_ecc_import_x963_ex in", in, inLen);
	    int err = MP_OKAY;
#ifndef WOLFSSL_ATECC508A
    int compressed = 0;
#endif /* !WOLFSSL_ATECC508A */
...
{
	print_title("wc_ecc_import_x963");
...
int wc_ecc_import_private_key_ex(const byte* priv, word32 privSz,
                                 ...
                                 int curve_id)
{
	print_title("wc_ecc_import_private_key_ex");
...
{
	print_title("wc_ecc_import_private_key");
